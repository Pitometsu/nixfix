...
(** @canonical Base.Commutative_group *)
module Commutative_group = Base__Commutative_group
...
(** @canonical Base.Heap_block *)
module Heap_block = Base__Heap_block
...
(** @canonical Base.Int_pow2 *)
module Int_pow2 = Base__Int_pow2
...
module Polymorphic_compare = Base__Polymorphic_compare
