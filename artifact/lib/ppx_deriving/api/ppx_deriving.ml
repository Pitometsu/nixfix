...
# 16 "ppx_deriving.cppo.ml"
type tyvar = string Location.loc

# 21 "ppx_deriving.cppo.ml"
type deriver = {
  name : string ;
...
# 300 "ppx_deriving.cppo.ml"
        let name = mkloc name param.ptyp_loc in
        
# 302 "ppx_deriving.cppo.ml"
        fn accum name
      | _ -> assert false)
    accum params
...
# 318 "ppx_deriving.cppo.ml"
        let name = mkloc name param.ptyp_loc in
        
# 320 "ppx_deriving.cppo.ml"
        fn name accum
      | _ -> assert false)
    params accum
...
# 336 "ppx_deriving.cppo.ml"
      [mkloc name typ.ptyp_loc]
    
# 340 "ppx_deriving.cppo.ml"
...
# 345 "ppx_deriving.cppo.ml"
      [mkloc name typ.ptyp_loc]
      
# 349 "ppx_deriving.cppo.ml"
      @ free_in x
...
# 364 "ppx_deriving.cppo.ml"
        name.txt
      
# 368 "ppx_deriving.cppo.ml"
      in
...
# 392 "ppx_deriving.cppo.ml"
    let name = name.txt in
    
# 394 "ppx_deriving.cppo.ml"
...
# 399 "ppx_deriving.cppo.ml"
    let name = name.txt in
    
# 401 "ppx_deriving.cppo.ml"
...
# 406 "ppx_deriving.cppo.ml"
    let name = name.txt in
    
# 408 "ppx_deriving.cppo.ml"
...
# 413 "ppx_deriving.cppo.ml"
    let name = name.txt in
    
# 415 "ppx_deriving.cppo.ml"
...
# 420 "ppx_deriving.cppo.ml"
    let name = name.txt in
    
# 422 "ppx_deriving.cppo.ml"
...
# 428 "ppx_deriving.cppo.ml"
      Typ.var ~loc:name.loc name.txt
    
# 432 "ppx_deriving.cppo.ml"
    in
...
# 552 "ppx_deriving.cppo.ml"
      String.capitalize_ascii
    
# 556 "ppx_deriving.cppo.ml"
...
# 569 "ppx_deriving.cppo.ml"
    rec_flag
  
# 571 "ppx_deriving.cppo.ml"
  | _ -> assert false
