...
# 68 "ppx_deriving_fold.cppo.ml"
          Pat.variant label popt
        
# 72 "ppx_deriving_fold.cppo.ml"
        in
        match field with
...
# 140 "ppx_deriving_fold.cppo.ml"
    (List.map (fun tyvar -> tyvar.txt))
      
# 142 "ppx_deriving_fold.cppo.ml"
