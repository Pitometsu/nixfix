...
(* OASIS_START *)
(* DO NOT EDIT (digest: c6da7bb33df941a852b7e7876ae6b3a8) *)
(*
     ...
     package =
       {
          ...
          description =
            Some
              [
                 OASISText.Para
                   "OUnit is a unit testing framework for OCaml, inspired by the JUnit tool for Java, and the HUnit tool for Haskell.";
                 OASISText.Para
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      ...
                      src_repo_browser =
                        Some "https://github.com/gildor478/ounit";
